...
import type { GoalFreezePeriodSyncRepository } from "./goalFreezePeriodSyncRepository";
...
export type GoalFreezePeriodSyncUsecase = {
  getFreezePeriods: (
    userId: UserId,
    since?: string,
...
export function newGoalFreezePeriodSyncUsecase(
  repo: GoalFreezePeriodSyncRepository,
  tracer: Tracer,
): GoalFreezePeriodSyncUsecase {
  return {
