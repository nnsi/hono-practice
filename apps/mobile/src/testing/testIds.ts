export const mobileTestIds = {
  ...
  notes: {
    ...
    bodyInput: "notes.bodyInput",
    markdownView: "notes.markdownView",
    activityToggle: "notes.activityToggle",
    activityOptionNone: "notes.activityOption.none",
    activityOption: (activityId: string) =>
      `notes.activityOption.${activityId}`,
