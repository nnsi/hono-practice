...
export function GoalHeatmap() {
  ...
  if (isLoading) {
    return (
      <View className="bg-white dark:bg-gray-800 rounded-xl p-3 items-center justify-center mb-3">
  ...
  return (
    <View className="bg-white dark:bg-gray-800 rounded-xl border border-gray-100 dark:border-gray-800 p-3 mb-3">
