...
export function UpgradeActionButtons({
  ...
  return (
    <View className="px-4 gap-3">
      {isPremium ? (
        <View
          className="bg-amber-50 dark:bg-amber-900/20 border border-amber-200 rounded-xl p-4"
          testID={mobileTestIdsExt.upgrade.premiumBadge}
        >
        ...
        <TouchableOpacity
          ...
          testID={mobileTestIdsExt.upgrade.purchaseButton}
        >
          {isPurchasing ? (
