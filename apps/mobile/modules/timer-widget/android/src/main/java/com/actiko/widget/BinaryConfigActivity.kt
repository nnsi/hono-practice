...
class BinaryConfigActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val activities = db.getActivitiesByRecordingMode("binary")
        if (activities.isEmpty()) {
            Toast.makeText(this, "\u30D0\u30A4\u30CA\u30EA\u6D3B\u52D5\u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093", Toast.LENGTH_LONG).show()
            finish()
            return
        }
    ...
    private fun showActivityList(activities: List<ActivityRow>) {
        ...
        listView.setOnItemClickListener { _, _, pos, _ ->
            ...
            prefs.saveWidgetConfig(appWidgetId, selected.id, "binary")
            BinaryWidgetProvider.updateWidget(this, AppWidgetManager.getInstance(this), appWidgetId)
