...
class CheckConfigActivity : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!WidgetSecurity.isRegisteredWidget(this, appWidgetId, CheckWidgetProvider::class.java) ||
        ...
        val activities = db.getActivitiesByRecordingMode("check")
        if (activities.isEmpty()) {
            Toast.makeText(this, "\u30C1\u30A7\u30C3\u30AF\u6D3B\u52D5\u304C\u898B\u3064\u304B\u308A\u307E\u305B\u3093", Toast.LENGTH_LONG).show()
            finish()
            return
        }
    ...
    private fun finishConfig(activityId: String, kindId: String?) {
        ...
        prefs.saveWidgetConfig(appWidgetId, activityId, "check")
        prefs.saveKindId(appWidgetId, kindId)
        CheckWidgetProvider.updateWidget(this, AppWidgetManager.getInstance(this), appWidgetId)
